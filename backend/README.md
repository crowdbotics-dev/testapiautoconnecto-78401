...
## Project Structure
    ...
    ├── testapiautoconnecto_78401  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_78401`
...
2. Clone this repo and `cd testapiautoconnecto_78401`
