"""
Django settings for testapiautoconnecto_78401 project.
...
ROOT_URLCONF = 'testapiautoconnecto_78401.urls'
...
WSGI_APPLICATION = 'testapiautoconnecto_78401.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautoconnecto_78401 API",
    "DESCRIPTION": "API documentation for testapiautoconnecto_78401 App",
    "VERSION": "v1",
}
